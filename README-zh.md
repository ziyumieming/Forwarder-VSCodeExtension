...
![Forwarder 主界面](media/images/forwarder-overview.png)
...
![类关系图](media/images/forwarder-class-graph.png) 
...
![函数调用图](media/images/forwarder-call-graph.png) 
...
- 路径结果可以继续生成路径摘要，帮助理解这条调用链大致完成了什么。
 ...
 ![调用路径](media/images/forwarder-call-path.png) 
...
![AI 摘要](media/images/forwarder-summary.png)
